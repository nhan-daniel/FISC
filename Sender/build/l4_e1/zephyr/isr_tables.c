...
struct _isr_table_entry __sw_isr_table _sw_isr_table[65] = {
	...
	{(const void *)0x1262d, (ISR)0x1bd99}, /* 42 */
	...
	{(const void *)0x1252d, (ISR)0x1bd99}, /* 49 */
