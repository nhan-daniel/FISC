...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_PUB_TOPIC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_SUB_TOPIC, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_CLIENT_ID, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_BROKER_HOSTNAME, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_BROKER_PORT, 1883);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_MESSAGE_BUFFER_SIZE, 128);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_PAYLOAD_BUFFER_SIZE, 128);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BUTTON_EVENT_PUBLISH_MSG, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TURN_LED_ON_CMD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TURN_LED_OFF_CMD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_RECONNECT_DELAY_S, 60);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LTE_NETWORK_MODE_LTE_M_NBIOT, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEAP_MEM_POOL_ADD_SIZE_SOCKETPAIR, 256);
